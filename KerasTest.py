...
X_train = X_train.astype('float32') #was bedeutet das? (und folgende drei Zeilen)
X_test = X_test.astype('float32')
X_train /= 255
X_test /= 255
 
# 6. Preprocess class labels
Y_train = np_utils.to_categorical(y_train, 10) #stattdessen iwie Tiernamen übergeben
...
model.fit(X_train, Y_train, 
          batch_size=32, epochs=10, verbose=1) #was ist die Batch-Size?
